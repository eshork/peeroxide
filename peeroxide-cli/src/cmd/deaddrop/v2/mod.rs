...
//! signed records; the data layer is a flat collection of immutable,
//! content-addressed records, each carrying a per-deaddrop salt slot for
//! DHT address-space isolation.
//!
